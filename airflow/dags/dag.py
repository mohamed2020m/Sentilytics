...
with DAG(
    ...
    inference_store = BashOperator(
        ...
        bash_command='python3 ../inference/inference_script.py'
    )

    # Task 3: Visualize Results
    visualize_results = BashOperator(
        task_id='visualize_results',
        bash_command='python3 ../visualization/visualization_script.py'
    )

    # Task 4: Remove Processed Documents
    ...
    # Task dependencies
    verify_documents >> inference_store >> visualize_results >> remove_processed_documents
